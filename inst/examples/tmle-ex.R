...
progressr::with_progress({
  psi2.1 <- lmtp_tmle(sim_t4, a, "Y", time_vary = tv, shift = d, folds = 2)
})
psi2.1
...
progressr::with_progress({
  psi2.2 <- lmtp_tmle(sim_t4, a, "Y", time_vary = tv, shift = d,
                      k = 0, folds = 2)
})
psi2.2
...
progressr::with_progress({
  psi2.4 <- lmtp_tmle(sim_t4, a, "Y", time_vary = tv, shift = d, k = 0, folds = 2)
})
psi2.4
...
cens <- c("C1", "C2")
y <- "Y"
psi4.1 <- lmtp_tmle(sim_cens, a, y, time_vary = tv, cens = cens, shift = NULL, folds = 2)
psi4.1
...
psi4.2 <- lmtp_tmle(sim_cens, a, y, time_vary = tv,
