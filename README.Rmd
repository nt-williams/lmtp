...
We're now ready to estimate the effect of our treatment policy, `d`. In this example, we'll use the cross-validated TML estimator with 10 folds. To speed up computation, we can use parallel processing supported by the `future` package.
